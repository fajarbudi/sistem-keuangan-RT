            ...
            <div class="modal-toggle-wrapper text-start dark-sign-up">
                <form id="formData" class=" needs-validation" novalidate="" method="POST">
                    ...
                    <div class="modal-body">
                        @csrf
                        <input type="hidden" name="nominal_nominal" id="nominal_nominal">
                        <div class="row g-3">
                            <div class="col-md-12">
                                <label class="form-label" for="nominal">Nominal</label>
                                <input class="form-control" id="nominal" type="text" placeholder="Masukkan Nominal..." required="" name="nominal">
                            </div>
                        </div>
                    </div>
