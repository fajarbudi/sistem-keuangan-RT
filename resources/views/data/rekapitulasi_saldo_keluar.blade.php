    ...
    <div class="container-fluid">
        <div class="page-title">
            <div style="display: flex; justify-content: space-between">
                <div>
                    <span class="f-30 f-w-400"><i class="icon-layers sembunyikan"></i> {{ $judulPage }} --
                        {{ $bulan }} {{ $tahun }}</span>
                </div>
                <div>
                    <div class="mx-2 mt-2">
                        <button class="btn btn-primary" type="button" onclick="filter()"><i class="fa fa-search"></i> <span
                                class="sembunyikan">Search</span></button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row widget-grid">
            <div class="col">
                <div style="display: flex; justify-content: flex-end; padding-right: 5%">
                    <p class="text-center">
                        <span style="font-size: 15px; font-weight: 500">Total Uang Keluar</span>
                        <br>
                        <strong style="font-size: 17px;">Rp
                            {{ number_format($total_saldo_keluar ?? 0, 0, ',', '.') }}</strong>
                    </p>
                </div>
                <div class="card">
                        ...
                        <div class="modal-body">
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <input class="form-control" id="fsaldo_keterangan" type="text"
                                        placeholder="Masukkan Keterangan..." name="saldo_keterangan">
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label" for="fjenis_uang_nama">Jenis Uang Keluar</label>
                                    <select id="fjenis_uang_nama" class="form-select form-select-sm"
                                        aria-label=".form-select-sm example" name="jenis_uang_nama">
                                        <option value="">--Pilih--</option>
                                        @foreach ($jenis_uang as $val)
                                            <option value="{{ $val->jenis_uang_nama }}">{{ $val->jenis_uang_nama }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <select id="fbulan" class="form-select form-select-sm"
                                        aria-label=".form-select-sm example" name="bulan">
                                        <option value="">--Pilih--</option>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select id="ftahun" class="form-select form-select-sm"
                                        aria-label=".form-select-sm example" name="tahun">
                                        <option value="">--Pilih--</option>
