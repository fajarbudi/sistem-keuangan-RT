                ...
                <div style="display: flex; justify-content: flex-end; padding-right: 5%">
                    <p class="text-center">
                        ...
                        <strong style="font-size: 17px;">Rp
                            {{ number_format($saldo_terakhir->saldo_total ?? 0, 0, ',', '.') }}</strong>
                    </p>
                </div>
                <div class="card">
                            ...
                            <tbody>
                                @foreach ($data as $index => $val)
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $val->saldo_status == 'masuk' ? number_format($val->saldo_nominal, 0, ',', '.') : '' }}
                                        </td>
                                        <td>{{ $val->saldo_status == 'keluar' ? number_format($val->saldo_nominal, 0, ',', '.') : '' }}
                                        </td>
